...
library(pheatmap) 
installed.packages()
setwd("C:/AI_Omics_Internship_2025/normalization.2")
load("processed_normalized_data.RData")
setwd("c:/AI_Omics_Internship_2025/normalization.2/raw_data_2")

annotation(GSE79973_RAW)
list.files("c:/AI_Omics_Internship_2025/normalization.2/raw_data_2")
library(affy)

cel_path <- "c:/AI_Omics_Internship_2025/normalization.2/raw_data_2/CEL_Files"
...
gene_map_df <- gene_symbols %>% as.data.frame() %>%
